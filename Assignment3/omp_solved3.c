...
/*
 Solution: the second to the last line "#pragma omp barrier" is outside the 
 parallel region so we remove it
 
 Actually it seems on my Mac omp_bug3 could run with no problems...
*/
